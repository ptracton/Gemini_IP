...
# Compile RTL
vlog -sv -work work $RTL_DIR/bus_matrix_regs.sv
vlog -sv -work work $RTL_DIR/bus_matrix_core.sv
vlog -sv -work work $RTL_DIR/bus_matrix_apb.sv
vlog -sv -work work $RTL_DIR/bus_matrix_axi.sv
vlog -sv -work work $RTL_DIR/bus_matrix_wb.sv

# Compile Testbenches
vlog -sv -work work $TB_DIR/tb_bus_matrix_core.sv
vlog -sv -work work $TB_DIR/tb_bus_matrix_apb.sv
vlog -sv -work work $TB_DIR/tb_bus_matrix_axi.sv
vlog -sv -work work $TB_DIR/tb_bus_matrix_wb.sv
...
proc sim_core {} {
    ...
    vsim -voptargs="+acc" -onfinish stop work.tb_bus_matrix_core
...
proc sim_apb {} {
    ...
    vsim -voptargs="+acc" -onfinish stop work.tb_bus_matrix_apb
...
proc sim_axi {} {
    ...
    vsim -voptargs="+acc" -onfinish stop work.tb_bus_matrix_axi
...
proc sim_wb {} {
    ...
    vsim -voptargs="+acc" -onfinish stop work.tb_bus_matrix_wb
