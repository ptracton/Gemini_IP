...
# Add Source Files
if { $LANG == "SV" } {
    set_global_assignment -name SYSTEMVERILOG_FILE "$VERILOG_RTL_DIR/timer_regs.sv"
    set_global_assignment -name SYSTEMVERILOG_FILE "$VERILOG_RTL_DIR/timer_core.sv"
    ...
    set_global_assignment -name VHDL_FILE "$VHDL_RTL_DIR/timer_regs.vhd"
    set_global_assignment -name VHDL_FILE "$VHDL_RTL_DIR/timer_core.vhd"
