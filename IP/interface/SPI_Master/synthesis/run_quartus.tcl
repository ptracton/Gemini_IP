# run_quartus.tcl
# Intel Quartus Synthesis Script for SPI Master
...
if { [string match "*_vhd" $target_design] } {
    ...
    set_global_assignment -name VHDL_FILE $ip_root/IP/interface/SPI_Master/rtl/vhdl/spi_master_core.vhd
    set_global_assignment -name VHDL_FILE $ip_root/IP/interface/SPI_Master/rtl/vhdl/spi_master_registers.vhd
    set_global_assignment -name VHDL_FILE $ip_root/IP/interface/SPI_Master/rtl/vhdl/${base_design}.vhd
    ...
    set_global_assignment -name SYSTEMVERILOG_FILE $ip_root/IP/interface/SPI_Master/rtl/verilog/spi_master_core.sv
    set_global_assignment -name SYSTEMVERILOG_FILE $ip_root/IP/interface/SPI_Master/rtl/verilog/spi_master_registers.sv
    set_global_assignment -name SYSTEMVERILOG_FILE $ip_root/IP/interface/SPI_Master/rtl/verilog/${target_design}.sv
