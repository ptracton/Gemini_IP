# run_vivado.tcl
# Xilinx Vivado Synthesis Script for SPI Master
...
if { [string match "*_vhd" $target_design] } {
    ...
    read_vhdl -vhdl2008 $ip_root/IP/interface/SPI_Master/rtl/vhdl/spi_master_core.vhd
    read_vhdl -vhdl2008 $ip_root/IP/interface/SPI_Master/rtl/vhdl/spi_master_registers.vhd
    read_vhdl -vhdl2008 $ip_root/IP/interface/SPI_Master/rtl/vhdl/${base_design}.vhd
    ...
    read_verilog -sv $ip_root/IP/interface/SPI_Master/rtl/verilog/spi_master_core.sv
    read_verilog -sv $ip_root/IP/interface/SPI_Master/rtl/verilog/spi_master_registers.sv
    read_verilog -sv $ip_root/IP/interface/SPI_Master/rtl/verilog/${target_design}.sv
