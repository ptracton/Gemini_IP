...
class alignas(VL_CACHE_LINE_BYTES) Vtop__Syms final : public VerilatedSyms {
  public:
    ...
    VerilatedScope* __Vscopep_gpio_axi__u_gpio_regs__unnamedblk1;
    VerilatedScope* __Vscopep_gpio_axi__u_gpio_regs__unnamedblk2;
    VerilatedScope* __Vscopep_gpio_axi__u_gpio_regs__unnamedblk3;
    VerilatedScope* __Vscopep_gpio_axi__u_gpio_regs__unnamedblk3__unnamedblk4;
    VerilatedScope* __Vscopep_gpio_axi__u_gpio_regs__unnamedblk3__unnamedblk4__unnamedblk5;
    VerilatedScope* __Vscopep_gpio_axi__u_gpio_regs__unnamedblk6;
    VerilatedScope* __Vscopep_gpio_axi__u_gpio_regs__unnamedblk7;
    VerilatedScope* __Vscopep_gpio_axi__u_gpio_regs__unnamedblk8;
    VerilatedScope* __Vscopep_gpio_axi__u_gpio_regs__unnamedblk9;
